...
class LoginForm(QtWidgets.QWidget):
    ...
    def _shrink_and_wrap(self, button, min_pt=8, padding=16):
        """Shrink font to fit; fall back to a simple two-line wrap. Uses button.width()."""
        text = button.text()
        font = button.font()
        # get starting pt
        pt = font.pointSize()
        ...
        # APPLY FONT AND SET HEIGHT FOR LINES
        button.setFont(font)
